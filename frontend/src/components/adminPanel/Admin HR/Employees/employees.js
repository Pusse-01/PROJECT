    ...
    addEmployee = () => {
        this.setState({
            ...
            if(this.state.registerEmployee.name==""||
                ...
                console.log(this.state.registerEmployee,this.state.confirmPassword)
                this.setState({
                ...
                if(result===true){
                    if(this.state.registerEmployee.password==this.state.confirmPassword){
                        console.log("before API call",this.state.registerEmployee)
                        ...
                        <form className="hr_employeeForm">
                            <div className="hr_employeeFormSub">
                                ...
                                <label className="hr_employeeLabel">
                                    Confirm Password
                                    <input
                                        value={this.state.registerEmployee.confirmPassword}
                                        className="hr_employeeTextInput"
                                        type="password"
                                ...
                                <label className="hr_employeeLabel">
                                    ...
                                    >
                                        <option disabled value={""}> -- Select a Designation (After Selecting Department) --</option>
